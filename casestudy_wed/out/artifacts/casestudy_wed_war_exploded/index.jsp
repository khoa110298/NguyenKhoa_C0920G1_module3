...
<%--          integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">--%>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul id="abc" class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="/abdajfs">Employee <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
  ...
  <div id="footer">
    <a href="#">
      <img src="anh/logo_codegym.jpg" height="30px" width="30px"> - <label>HỆ THỐNG ĐÀO TẠO LẬP TRÌNH VIÊN HIỆN
      ĐẠI</label>
    </a>
  </div>
